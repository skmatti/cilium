...
func initEnv(vp *viper.Viper, cmd *cobra.Command) {
	// Prepopulate option.Config with options from CLI.
	option.Config.Populate(vp)

	k8s.Configure(option.K8sAPIServer, option.K8sKubeConfigPath, defaults.K8sClientQPSLimit, defaults.K8sClientBurst)
