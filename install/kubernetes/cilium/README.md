...
![Version: 1.13.12](https://img.shields.io/badge/Version-1.13.12-informational?style=flat-square) ![AppVersion: 1.13.12](https://img.shields.io/badge/AppVersion-1.13.12-informational?style=flat-square)
...
| bpf.events | object | `{"default":{"burstLimit":null,"rateLimit":null},"drop":{"enabled":true},"policyVerdict":{"enabled":true},"trace":{"enabled":true}}` | Control events generated by the Cilium datapath exposed to Cilium monitor and Hubble. |
...
| clustermesh.apiserver.image | object | `{"digest":"","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/clustermesh-apiserver","tag":"v1.13.12","useDigest":false}` | Clustermesh API server image. |
...
| hubble.export | object | `{"dynamic":{"config":{"content":"- name: all\n  fieldMask: []\n  includeFilters: []\n  excludeFilters: []\n  filePath: \"/var/run/cilium/hubble/events.log\"\n","createMap":true,"mapName":"cilium-flowlog-config"},"enabled":false},"fileMaxBackups":5,"fileMaxSizeMb":10,"static":{"allowList":[],"denyList":[],"enabled":false,"fieldMask":[],"filePath":"/var/run/cilium/hubble/events.log"}}` | Hubble flows export. |
| hubble.export.dynamic | object | `{"config":{"content":"- name: all\n  fieldMask: []\n  includeFilters: []\n  excludeFilters: []\n  filePath: \"/var/run/cilium/hubble/events.log\"\n","createMap":true,"mapName":"cilium-flowlog-config"},"enabled":false}` | - Dynamic exporters configuration. Dynamic exporters may be reconfigured without a need of agent restarts. |
| hubble.export.dynamic.config.content | string | `"- name: all\n  fieldMask: []\n  includeFilters: []\n  excludeFilters: []\n  filePath: \"/var/run/cilium/hubble/events.log\"\n"` | -- Exporters configuration in YAML format. |
| hubble.export.dynamic.config.createMap | bool | `true` | -- True if helm installer should create config map. Switch to false if you want to self maintain the file content. |
| hubble.export.dynamic.config.mapName | string | `"cilium-flowlog-config"` | -- Name of configmap with configuration that may be altered to reconfigure exporters within a running agents. |
...
| hubble.relay.image | object | `{"digest":"","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/hubble-relay","tag":"v1.13.12","useDigest":false}` | Hubble-relay container image. |
...
| hubble.ui.backend.image | object | `{"override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/hubble-ui-backend","tag":"v0.13.0@sha256:1e7657d997c5a48253bb8dc91ecee75b63018d16ff5e5797e5af367336bc8803"}` | Hubble-ui backend image. |
...
| hubble.ui.frontend.image | object | `{"override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/hubble-ui","tag":"v0.13.0@sha256:7d663dc16538dd6e29061abd1047013a645e6e69c115e008bee9ea9fef9a6666"}` | Hubble-ui frontend image. |
...
| image | object | `{"digest":"","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium","tag":"v1.13.12","useDigest":false}` | Agent container image. |
...
| operator.image | object | `{"alibabacloudDigest":"","awsDigest":"","azureDigest":"","genericDigest":"","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/operator","suffix":"","tag":"v1.13.12","useDigest":false}` | cilium-operator image. |
...
| preflight.image | object | `{"digest":"","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium","tag":"v1.13.12","useDigest":false}` | Cilium pre-flight image. |
