...
import (
	...
	"gke-internal.googlesource.com/anthos-networking/ipam-controller/api/client/clientset/versioned/scheme"
...
func (c *ApiV1alpha1Client) ClusterCIDRConfigs(namespace string) ClusterCIDRConfigInterface {
	return newClusterCIDRConfigs(c, namespace)
}
