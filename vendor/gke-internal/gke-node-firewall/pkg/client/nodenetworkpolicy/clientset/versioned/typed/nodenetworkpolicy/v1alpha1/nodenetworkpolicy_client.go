...
import (
	...
	"gke-internal/gke-node-firewall/pkg/client/nodenetworkpolicy/clientset/versioned/scheme"
...
func (c *NetworkingV1alpha1Client) NodeNetworkPolicies() NodeNetworkPolicyInterface {
	return newNodeNetworkPolicies(c)
}
