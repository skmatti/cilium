...
PKTGEN("tc", "decap4")
int test_geneve_tc_decap4_pktgen(struct __ctx_buff *ctx)
{
...
CHECK("tc", "decap4")
int test_geneve_tc_decap4_check(struct __ctx_buff *ctx)
{
...
PKTGEN("tc", "encap4")
int test_geneve_tc_encap4_pktgen(struct __ctx_buff *ctx)
{
	struct pktgen builder;
	pktgen__init(&builder, ctx);
...
CHECK("tc", "encap4")
int test_geneve_tc_encap4_check(struct __ctx_buff *ctx)
{
...
PKTGEN("tc", "encap_decap_cycle")
int test_geneve_tc_encap_decap_cycle_pktgen(struct __ctx_buff *ctx)
{
	struct pktgen builder;
	pktgen__init(&builder, ctx);
...
CHECK("tc", "encap_decap_cycle")
int test_geneve_tc_encap_decap_cycle_check(struct __ctx_buff *ctx)
{
	struct geneve_encaphdr4 hdr = {};
	struct geneve_metadata meta = {};
...
PKTGEN("tc", "decap_error_short")
int test_geneve_tc_decap_error_short_pktgen(struct __ctx_buff *ctx)
{
	struct pktgen builder;
	pktgen__init(&builder, ctx);
...
CHECK("tc", "decap_error_short")
int test_geneve_tc_decap_error_short_check(struct __ctx_buff *ctx)
{
	struct geneve_metadata meta = {};
	test_init();
...
PKTGEN("tc", "decap_with_options")
int test_geneve_tc_decap_with_options_pktgen(struct __ctx_buff *ctx)
{
	struct pktgen builder;
	struct google_pktgen__genevehdr_params params = {
...
CHECK("tc", "decap_with_options")
int test_geneve_tc_decap_with_options_check(struct __ctx_buff *ctx)
{
	struct geneve_metadata meta = {};
	test_init();
...
PKTGEN("tc", "encap_error_data")
int test_geneve_tc_encap_error_data_pktgen(struct __ctx_buff *ctx)
{
	(void)ctx;
	return 0; // Empty packet
}

CHECK("tc", "encap_error_data")
int test_geneve_tc_encap_error_data_check(struct __ctx_buff *ctx)
{
	struct geneve_encaphdr4 hdr = {};
	struct geneve_metadata meta = {};
	test_init();
