...
require (
	...
	gke-internal.googlesource.com/anthos-networking/apis/v2 v2.1.1-gke.2
	...
	gke-internal.googlesource.com/third_party/cilium v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/cilium/hive v0.0.0-20241011093954-8df06c41a157 // indirect
...
replace (
	github.com/cilium/cilium => github.com/cilium/cilium v1.16.10
	gke-internal.googlesource.com/anthos-networking/apis/v2 => gke-internal.googlesource.com/anthos-networking.git/apis/v2 v2.12.4
	...
	gke-internal.googlesource.com/anthos-networking/test-infra => gke-internal.googlesource.com/anthos-networking.git/test-infra v0.0.0-20250710201912-213cd82d7487
	...
	// TODO(b/439966742): Fix current import where using local directory adds dependency for this test which can only be run in the directory in Cloud nat WORA test
	gke-internal.googlesource.com/third_party/cilium => ../..
