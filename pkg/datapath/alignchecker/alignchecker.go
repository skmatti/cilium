...
func CheckStructAlignments(path string) error {
	...
	toCheck := map[string][]reflect.Type{
		...
		"pip_cidr_key":            {reflect.TypeOf(pip.CIDRKey{})},
		"pip_routing_entry":       {reflect.TypeOf(pip.RoutingEntry{})},
		"ratelimit_metrics_key":   {reflect.TypeOf(ratelimitmetricsmap.Key{})},
		"ratelimit_metrics_value": {reflect.TypeOf(ratelimitmetricsmap.Value{})},
	}
