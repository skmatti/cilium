...
func (k *FlowKey4) New() bpf.MapKey { return &FlowKey4{} }
...
func (k *FlowEntry4) New() bpf.MapValue { return &FlowEntry4{} }
...
func FlowGC() float64 {
	...
	return float64(deleted) / float64(FlowMapAny4.MaxEntries())
}
