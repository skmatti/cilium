...
// SelectKey must match 'struct sfc_select_key' in "bpf/lib/google_sfc.h".
...
// SelectEntry must match 'struct sfc_select_entry' in "bpf/lib/google_sfc.h".
...
func (key *SelectKey) New() bpf.MapKey { return &SelectKey{} }
...
func (entry *SelectEntry) New() bpf.MapValue { return &SelectEntry{} }
