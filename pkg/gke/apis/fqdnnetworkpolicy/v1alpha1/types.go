...
// FQDNPolicyEgressRule identifies a set of endpoints traffic is allowed
// to. The exact L4 endpoints are constructed as a cross-product between
// the matches and ports lists.
...
// Exactly one of the sub-fields of FQDNNetworkPolicyMatch must be set. An empty
// struct is not allowed. A struct setting both Name and Pattern is not allowed.
//
