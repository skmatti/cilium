	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expect: api.Rule{
				...
				EnableDefaultDeny: api.DefaultDenyConfig{Ingress: ptr.To(false), Egress: ptr.To(false)},
			},
		},
		{
			...
			expect: api.Rule{
				...
				EnableDefaultDeny: api.DefaultDenyConfig{Ingress: ptr.To(true), Egress: ptr.To(false)},
			},
		},
		{
