...
type Controller struct {
	...
	pm       types.PolicyManager

	stopCh chan struct{}
}

func NewController(client versioned.Interface, pm types.PolicyManager) *Controller {
...
func (c *Controller) Start(ctx context.Context) error {
	...
	if !cache.WaitForNamedCacheSync("fqdnNetworkPolicyController", ctx.Done(), c.informer.HasSynced) {
		return fmt.Errorf("FQDN Network Policy informer failed to sync")
	}
	return nil
}
