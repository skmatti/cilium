...
type NetworkingV1alpha1Interface interface {
	...
	TrafficSteeringsGetter
	TrafficSteeringListsGetter
}
...
func (c *NetworkingV1alpha1Client) TrafficSteerings(namespace string) TrafficSteeringInterface {
	return newTrafficSteerings(c, namespace)
}

func (c *NetworkingV1alpha1Client) TrafficSteeringLists(namespace string) TrafficSteeringListInterface {
	return newTrafficSteeringLists(c, namespace)
}
