...
import (
	...
	versioned "github.com/cilium/cilium/pkg/gke/client/nodepool/clientset/versioned"
	internalinterfaces "github.com/cilium/cilium/pkg/gke/client/nodepool/informers/externalversions/internalinterfaces"
	v1 "github.com/cilium/cilium/pkg/gke/client/nodepool/listers/nodepool/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BaremetalV1().NodePools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BaremetalV1().NodePools(namespace).Watch(context.TODO(), options)
			},
		},
		&nodepoolv1.NodePool{},
		resyncPeriod,
...
func (f *nodePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodepoolv1.NodePool{}, f.defaultInformer)
}
