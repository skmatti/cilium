...
import (
	...
	"github.com/cilium/cilium/pkg/gke/client/remotenode/clientset/versioned/scheme"
...
func (c *NetworkingV1alpha1Client) RemoteNodes(namespace string) RemoteNodeInterface {
	return newRemoteNodes(c, namespace)
}

func (c *NetworkingV1alpha1Client) RemoteNodeLists(namespace string) RemoteNodeListInterface {
	return newRemoteNodeLists(c, namespace)
}
