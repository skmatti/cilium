...
type NetworkingV1alpha1Interface interface {
	...
	NetworkLoggingsGetter
	NetworkLoggingListsGetter
}
...
func (c *NetworkingV1alpha1Client) NetworkLoggings() NetworkLoggingInterface {
	return newNetworkLoggings(c)
}

func (c *NetworkingV1alpha1Client) NetworkLoggingLists() NetworkLoggingListInterface {
	return newNetworkLoggingLists(c)
}
