...
type NetworkingV1alpha1Interface interface {
	...
	RedirectServicesGetter
	RedirectServiceListsGetter
}
...
func (c *NetworkingV1alpha1Client) RedirectServices(namespace string) RedirectServiceInterface {
	return newRedirectServices(c, namespace)
}

func (c *NetworkingV1alpha1Client) RedirectServiceLists(namespace string) RedirectServiceListInterface {
	return newRedirectServiceLists(c, namespace)
}
