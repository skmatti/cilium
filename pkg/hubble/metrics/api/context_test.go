...
func TestParseGetLabelValues(t *testing.T) {
	...
	assert.EqualValues(t,
		[]string{"foo/foo-123"},
		opts.GetLabelValues(&pb.Flow{Source: &pb.Endpoint{Namespace: "foo", PodName: "foo-123"}, TrafficDirection: pb.TrafficDirection_EGRESS}))
	...
	assert.EqualValues(t,
		[]string{"foo/foo"},
		opts.GetLabelValues(&pb.Flow{Source: &pb.Endpoint{Namespace: "foo", PodName: "foo-123"}, TrafficDirection: pb.TrafficDirection_INGRESS}))
	...
	assert.EqualValues(t,
		[]string{"foo/foo"},
		opts.GetLabelValues(&pb.Flow{Source: &pb.Endpoint{Namespace: "foo", PodName: "foo-123"}, TrafficDirection: pb.TrafficDirection_TRAFFIC_DIRECTION_UNKNOWN}))
	...
	assert.EqualValues(t,
		[]string{"foo/bar-bar"},
		opts.GetLabelValues(&pb.Flow{Destination: &pb.Endpoint{Namespace: "foo", PodName: "bar-bar-123-123"}, TrafficDirection: pb.TrafficDirection_EGRESS}))
	...
	assert.EqualValues(t,
		...
		opts.GetLabelValues(&pb.Flow{Destination: &pb.Endpoint{Namespace: "foo", PodName: "bar-bar-123-123"}, TrafficDirection: pb.TrafficDirection_INGRESS}))
	...
	assert.EqualValues(t,
		[]string{"foo/bar-bar"},
		opts.GetLabelValues(&pb.Flow{Destination: &pb.Endpoint{Namespace: "foo", PodName: "bar-bar-123-123"}, TrafficDirection: pb.TrafficDirection_TRAFFIC_DIRECTION_UNKNOWN}))
