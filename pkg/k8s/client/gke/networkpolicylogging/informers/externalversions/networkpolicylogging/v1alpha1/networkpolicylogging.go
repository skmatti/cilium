...
import (
	...
	networkpolicyloggingv1alpha1 "github.com/cilium/cilium/pkg/k8s/apis/gke/networkpolicylogging/v1alpha1"
	versioned "github.com/cilium/cilium/pkg/k8s/client/gke/networkpolicylogging/clientset/versioned"
	internalinterfaces "github.com/cilium/cilium/pkg/k8s/client/gke/networkpolicylogging/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/cilium/cilium/pkg/k8s/client/gke/networkpolicylogging/listers/networkpolicylogging/v1alpha1"
...
// NetworkPolicyLoggingInformer provides access to a shared informer and lister for
// NetworkPolicyLoggings.
type NetworkPolicyLoggingInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.NetworkPolicyLoggingLister
}
...
func (f *networkPolicyLoggingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkpolicyloggingv1alpha1.NetworkPolicyLogging{}, f.defaultInformer)
}

func (f *networkPolicyLoggingInformer) Lister() v1alpha1.NetworkPolicyLoggingLister {
	return v1alpha1.NewNetworkPolicyLoggingLister(f.Informer().GetIndexer())
}
