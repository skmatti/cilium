...
// IterateWithCallback runs the callback on each entry of the mock map.
func (m *RatelimitMetricsMockMap) IterateWithCallback(cb ratelimitmetricsmap.IterateCallback) error {
	if cb == nil {
		return nil
	}
