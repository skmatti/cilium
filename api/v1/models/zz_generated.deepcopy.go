...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointChangeRequest) DeepCopyInto(out *EndpointChangeRequest) {
	*out = *in
	...
	if in.DatapathConfiguration != nil {
		in, out := &in.DatapathConfiguration, &out.DatapathConfiguration
		*out = new(EndpointDatapathConfiguration)
		(*in).DeepCopyInto(*out)
	}
	if in.Labels != nil {
	...
	if in.State != nil {
		...
		*out = new(EndpointState)
		**out = **in
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointChangeRequest.
func (in *EndpointChangeRequest) DeepCopy() *EndpointChangeRequest {
	if in == nil {
		return nil
	}
	out := new(EndpointChangeRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointDatapathConfiguration) DeepCopyInto(out *EndpointDatapathConfiguration) {
	*out = *in
	if in.RequireRouting != nil {
		in, out := &in.RequireRouting, &out.RequireRouting
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointDatapathConfiguration.
func (in *EndpointDatapathConfiguration) DeepCopy() *EndpointDatapathConfiguration {
	if in == nil {
		return nil
	}
	out := new(EndpointDatapathConfiguration)
